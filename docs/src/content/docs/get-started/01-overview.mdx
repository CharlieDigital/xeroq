...
Xeroq is a ***headless***, peer-to-peer implementation of content exchange between two devices.  This means that you can bring your own UI and integrate it into your existing forms.
